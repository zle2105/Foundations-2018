...
module.exports = "/world.beb7d96c.topojson";
},{}],"data\\world-cities.csv":[function(require,module,exports) {
"use strict";

module.exports = "/world-cities.f41c4b99.csv";
},{}],"01-map.js":[function(require,module,exports) {
'use strict';
...
var colorScale = d3.scaleSequential(d3.interpolateCool).domain([0, 100000]).clamp(true);
...
function ready(_ref) {
  ...
  var country = topojson.feature(json, json.objects.countries);

  svg.selectAll('.country').data(country.features).enter().append('path').attr('class', 'country').attr('d', path).attr('fill', 'black').attr('stroke', 'white');

  svg.append('path').datum(graticule()).attr('d', path).attr('stroke', 'white').lower();

  svg.append('rect').attr('height', height).attr('width', width).attr('fill', 'black').lower();

  svg.selectAll('.cities').data(datapoints).enter().append('circle').attr('class', 'city').attr('r', 1.5).attr('fill', function (d) {
...
},{"d3":"..\\node_modules\\d3\\index.js","topojson":"..\\node_modules\\topojson\\index.js","./data/world.topojson":"data\\world.topojson","./data/world-cities.csv":"data\\world-cities.csv"}],"..\\..\\..\\..\\AppData\\Roaming\\npm\\node_modules\\parcel\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["..\\..\\..\\..\\AppData\\Roaming\\npm\\node_modules\\parcel\\src\\builtins\\hmr-runtime.js","01-map.js"], null)
//# sourceMappingURL=/01-map.45f4f735.map